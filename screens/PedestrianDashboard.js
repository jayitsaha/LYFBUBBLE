    ...
    >
        ...
        <View style={{
            ...
            <View style={styles.colCard}>
             ...
             color: this.props.bg == "red" ? "#FFF":"#3a4b4f",}}>LYF RESIDENT SCORE</Text>
            <Text style={{
                ...styles.numberCard,
                ...
                <Text style={{marginTop: -23, marginLeft: 80, fontSize: 16, fontWeight: "bold"}}>GUARDIAN COVERAGE %</Text>
                </TouchableOpacity>
                ...
                <Text style={{marginTop: -26, marginLeft: 140, fontSize: 16, fontWeight: "bold", marginBottom: 20}}>LYF BOT </Text>
                </TouchableOpacity>

...
//    return returnValue;
  ...
  return (
    <View style={styles.container}>
      <StatusBar backgroundColor="#FEE13F" barStyle="light-content" hidden />
      <View style={{
        flex: 1,
    justifyContent: 'center',
        ...
        <Image
              ...
              source={{uri: 'https://res.cloudinary.com/dyfmlusbc/image/upload/v1729849450/Screenshot_2024-10-25_at_3.13.10_PM_yibsbq.png'}}
            />
      </View>
      ...
      <Animatable.View
        ...
        <View style={styles.action}>
          <FontAwesome name="user-o" color={colors.text} size={20} style={{marginBottom: 11}}/>
          <TextInput
          ...
          {data.check_textInputChange ? (
            <Animatable.View animation="bounceIn" style={{marginBottom: 11}}>
        ...
        <View style={styles.action}>
          <Feather name="lock" color={colors.text} size={20} style={{marginBottom: 11}}/>
          <TextInput
          ...
          />
          <TouchableOpacity onPress={updateSecureTextEntry} style={{marginBottom: 11}}>
        ...
        {/*Needs to be built*/}
        <TouchableOpacity>
          <Text style={{color: '#2F4858', marginTop: 15, marginLeft: 20}}>
            Forgot password?
          </Text>
        </TouchableOpacity>
              ...
              if (1==1) {
                sendLoginDetailsToSever().then(value => {
                  ...
                  if (1==1) {
                    ...
                    if(data['username'] == "lyfcitizen"){
                      navigation.navigate('LyfBubbleHomeScreen', {
                        username: 'username',
                        jwt: 'token',
                      });
                    }

                    if(data['username'] == "lyfchampion"){
                      navigation.navigate('LyfSec', {
                        username: 'username',
                        jwt: 'token',
                      });
                    }

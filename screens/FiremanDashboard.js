...
import NavOptions from '../components/NavOptionsFireMan';
...
import Chart from '../components/ChartFire';
...
//                    source={require("../images/unnamed.jpg")}
                    style={styles.map}
                >
                    <Text style={tw` text-lg font-bold text-center`}>FIREMAN DASHBOARD</Text>
                     <Chart/>
                     <TouchableOpacity

...
const SplashView: React.FC<Props> = ({ onNextClick, animationController }) => {
  ...
  const introImageData = Image.resolveAssetSource(AppImages.page1);
  ...
  return (
    ...
    >
      <ScrollView style={{ flexGrow: 0 }} alwaysBounceVertical={false}>
        ...
        <Text style={styles.title}>PEDESTRIAN</Text>
        <Text style={styles.subtitle}>
        {'\n'}
        See it? Snap it! Be a GUARDIAN of your community.{'\n'}{'\n'}
        Your camera is a powerful tool. Help us keep our city safe and clean {'\n'}{'\n'}
        {/* Revolutionize visual analysis with Mod-Eye's modular intelligence. */}
        Every picture makes a difference. Report, protect, and improve
        {/* As a Supplier, gets Real-time info on your Product Health, and request Tasks to PSPs */}
